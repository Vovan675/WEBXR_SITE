...
<html lang="en-us">
  <head>
    ...
    <title>Unity WebGL Player | Maze_WebXR</title>
    ...
    <script>
      ...
      var unityInstance = UnityLoader.instantiate("unityContainer", "Build/Game.json", {onProgress: function f(instance, progress) { UnityProgress(instance, progress); unityInstance.SendMessage("Menu", "SetName", "<?php echo $_POST["name"]; ?>");}});
    </script>
  </head>
  <body>
    <div class="webgl-content">
      ...
      <div class="footer">
        ...
        <div class="title">Maze_WebXR</div>
      </div>
    </div>
    <script>
